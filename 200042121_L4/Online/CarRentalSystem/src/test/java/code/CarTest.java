...
public class CarTest {
    ...
    @Test
    void testNoLateFee() {
        Car car = new Car("C123", 2022, "Toyota", "Camry", 1, new VehicleType(4));
    ...
    void testCompleteMaintenance() {
        Car car = new Car("C123", 2022, "Toyota", "Camry", 2, new VehicleType(4));
        assertTrue(car.completeMaintenance());
    }

    @Test
    void testCompletedMaintenance() {
        Car car = new Car("C123", 2022, "Toyota", "Camry", 0, new VehicleType(4));
